...
export default function TenantsPage() {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-md shadow-2xs overflow-hidden">
      ...
      {/* High Density Table Grid (Desktop Only) */}
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5 text-[11px] text-slate-500">
                        <span className="font-mono">
                          KH-{tenant.id.replace('tenant-', '').slice(-4).toUpperCase()}
                        </span>
                        <span>•</span>
                  ...
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold shrink-0 ${tamTruCfg.badgeClass}`}
                  >
                    <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${tamTruCfg.dotClass}`} />
                    {tamTruCfg.label}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs pt-1.5 border-t border-slate-100">
                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-semibold">Phòng đang ở</div>
                    <div className="mt-0.5 font-bold">
                      {room ? (
                        ...
                        <span className="text-slate-400 italic font-normal">Chưa xếp phòng</span>
                      )}
                    </div>
                  </div>

                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-semibold">Công nợ</div>
                    <div
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-0.5 font-mono text-emerald-700 font-bold hover:underline flex items-center gap-1"
                    >
                  ...
                  <div>
                    <div className="text-[10px] text-slate-400 uppercase font-semibold">CCCD / Quê quán</div>
                    <div className="mt-0.5 text-slate-800 truncate">
                      <span className="font-mono font-medium">{tenant.cccd}</span>
                      {tenant.hometown && (
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      onClick={() => handleCall(tenant.phone, tenant.name)}
                      className="p-1.5 text-emerald-600 hover:bg-emerald-50 rounded-sm border border-emerald-200 transition-colors cursor-pointer"
                      title={`Gọi ${tenant.phone}`}
                    >
                      <Phone className="w-3.5 h-3.5" />
                    </button>
